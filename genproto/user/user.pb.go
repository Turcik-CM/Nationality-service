...
var file_user_user_proto_rawDesc = []byte{
	...
	0x66, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x69, 0x6e, 0x67, 0x32, 0xcc, 0x09, 0x0a, 0x0b, 0x55, 0x73,
	...
	0x6e, 0x73, 0x65, 0x12, 0x3b, 0x0a, 0x0a, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x45, 0x6d, 0x61, 0x69,
	...
	0x72, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x31,
	...
	0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x0f, 0x5a, 0x0d, 0x67, 0x65, 0x6e, 0x70,
...
var file_user_user_proto_depIdxs = []int32{
	...
	19, // 2: user.UserService.Create:input_type -> user.CreateRequest
	18, // 3: user.UserService.GetProfile:input_type -> user.Id
	24, // 4: user.UserService.UpdateProfile:input_type -> user.UpdateProfileRequest
	27, // 5: user.UserService.ChangePassword:input_type -> user.ChangePasswordRequest
	29, // 6: user.UserService.ChangeProfileImage:input_type -> user.URL
	25, // 7: user.UserService.FetchUsers:input_type -> user.Filter
	18, // 8: user.UserService.ListOfFollowing:input_type -> user.Id
	18, // 9: user.UserService.ListOfFollowers:input_type -> user.Id
	18, // 10: user.UserService.DeleteUser:input_type -> user.Id
	15, // 11: user.UserService.Follow:input_type -> user.FollowReq
	15, // 12: user.UserService.Unfollow:input_type -> user.FollowReq
	18, // 13: user.UserService.GetUserFollowers:input_type -> user.Id
	18, // 14: user.UserService.GetUserFollows:input_type -> user.Id
	17, // 15: user.UserService.MostPopularUser:input_type -> user.Void
	2,  // 16: user.UserService.Register:input_type -> user.RegisterRequest
	4,  // 17: user.UserService.LoginEmail:input_type -> user.LoginEmailRequest
	5,  // 18: user.UserService.LoginUsername:input_type -> user.LoginUsernameRequest
	8,  // 19: user.UserService.AcceptCodeToRegister:input_type -> user.AcceptCode
	9,  // 20: user.UserService.ForgotPassword:input_type -> user.ForgotPasswordRequest
	10, // 21: user.UserService.RegisterAdmin:input_type -> user.Message
	11, // 22: user.UserService.ResetPassword:input_type -> user.ResetPassReq
	1,  // 23: user.UserService.GetUserByEmail:input_type -> user.Email
	12, // 24: user.UserService.UpdatePassword:input_type -> user.UpdatePasswordReq
	20, // 25: user.UserService.Create:output_type -> user.UserResponse
	23, // 26: user.UserService.GetProfile:output_type -> user.GetProfileResponse
	20, // 27: user.UserService.UpdateProfile:output_type -> user.UserResponse
	28, // 28: user.UserService.ChangePassword:output_type -> user.ChangePasswordResponse
	17, // 29: user.UserService.ChangeProfileImage:output_type -> user.Void
	26, // 30: user.UserService.FetchUsers:output_type -> user.UserResponses
	32, // 31: user.UserService.ListOfFollowing:output_type -> user.Follows
	32, // 32: user.UserService.ListOfFollowers:output_type -> user.Follows
	17, // 33: user.UserService.DeleteUser:output_type -> user.Void
	16, // 34: user.UserService.Follow:output_type -> user.FollowRes
	13, // 35: user.UserService.Unfollow:output_type -> user.DFollowRes
	14, // 36: user.UserService.GetUserFollowers:output_type -> user.Count
	14, // 37: user.UserService.GetUserFollows:output_type -> user.Count
	20, // 38: user.UserService.MostPopularUser:output_type -> user.UserResponse
	3,  // 39: user.UserService.Register:output_type -> user.RegisterResponse
	0,  // 40: user.UserService.LoginEmail:output_type -> user.LoginResponse1
	22, // 41: user.UserService.LoginUsername:output_type -> user.LoginResponse
	3,  // 42: user.UserService.AcceptCodeToRegister:output_type -> user.RegisterResponse
	10, // 43: user.UserService.ForgotPassword:output_type -> user.Message
	10, // 44: user.UserService.RegisterAdmin:output_type -> user.Message
	10, // 45: user.UserService.ResetPassword:output_type -> user.Message
	23, // 46: user.UserService.GetUserByEmail:output_type -> user.GetProfileResponse
	10, // 47: user.UserService.UpdatePassword:output_type -> user.Message
